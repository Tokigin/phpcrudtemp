    ...
    <div id=<?php echo "$id"; ?> class="carousel slide">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="data:image/png;base64,<?php echo $img1; ?>" class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item">
                <img src="data:image/png;base64,<?php echo $img2; ?>" class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item">
                <img src="data:image/png;base64,<?php echo $img3; ?>" class="d-block w-100" alt="..." />
            </div>
        </div>
